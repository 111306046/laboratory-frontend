...
import { setUserPermissions } from '../utils/auth';
...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 存儲用戶權限
      if (data.func_permissions) {
        console.log('Setting permissions:', data.func_permissions); // 調試信息
        setUserPermissions(data.func_permissions);
      } else {
        // 如果是 superuser，手動設置權限
        console.log('Setting superuser permissions'); // 調試信息
        setUserPermissions(['superuser']);
      }
